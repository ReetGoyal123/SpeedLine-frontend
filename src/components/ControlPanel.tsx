...
import { RotateCcw, Play, Pause, Sun, Moon, Activity, RefreshCw } from 'lucide-react';
...
const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  const handleToggleTheme = () => {
    ...
    // In a real implementation, you'd toggle the dark class on document.documentElement
    console.log('Theme toggle clicked (demo mode)');
  };
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4">
            ...
            >
              ...
              >
                <motion.div
                  animate={isDarkMode ? { rotate: [0, 180] } : { rotate: [180, 0] }}
